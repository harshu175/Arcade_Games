...
const btnEl = document.getElementById("startGameBtn");
const modal = document.getElementById("modal");
const bigScore = document.getElementById("bigScoreEl");
...
btnEl.addEventListener("click", (e)=>{
    spawnEnemiesInterval = setInterval(spawnEnemies, 1500);
    init();
    animate();
    spawnEnemies();
